...
namespace VoltLangNET
{
    ...
    public static unsafe class VoltNative
    {
        ...
        public static bool volt_virtual_machine_get_registers(VirtualMachinePointer vm, out Span<VoltObject> buffer)
        {
            buffer = default;
            ...
            buffer = new Span<VoltObject>(ptr.ToPointer(), (int)size);
        ...
        [DllImport(LIBRARY_NAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool volt_stack_push(StackPointer stack, VoltObject obj);

        [DllImport(LIBRARY_NAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool volt_stack_pop(StackPointer stack, out VoltObject obj);
